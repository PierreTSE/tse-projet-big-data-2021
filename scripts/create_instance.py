...
ec2 = boto3.resource('ec2', aws_access_key_id=KEY, aws_secret_access_key=SECRET, aws_session_token=Token,
...
if existe == False:
    ...
    os.rename(os.path.dirname(path_fichier_config) + "properties1.txt",
              os.path.dirname(path_fichier_config) + "properties.txt")
    ...
    ec2_client = boto3.client('ec2', aws_access_key_id=KEY, aws_secret_access_key=SECRET, aws_session_token=Token,
                              region_name='us-east-1')
